                                        ...
                                        {manualExercises.filter(ex => ex.dia === day).map(ex => (
                                            <div key={ex.id} style={styles.manualExerciseItem}>
                                                <div style={{ flex: 1, textAlign: 'left' }}>
                                                    <span style={styles.manualExCategory}>{ex.categoria === 'calentamiento' ? '🔥' : '💪'}</span>
        ...
        <div style={styles.content}>
            ...
            <div style={styles.descriptionSection}>
                ...
                <div style={{ fontSize: '11px', color: Colors.textTertiary, marginBottom: '8px', textAlign: 'left' }}>
                    💡 Tip: Indica qué días entrenas o qué significan los símbolos de tu rutina para un análisis perfecto.
                </div>
                <textarea
