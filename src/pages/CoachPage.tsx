    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            role: 'assistant',
            content: `¡Hola ${perfil.usuario.nombre || 'atleta'}! 👋 Soy tu Coach IA personal. ¿En qué puedo ayudarte hoy? Puedo darte consejos sobre tu rutina, nutrición, o ayudarte a planificar tus entrenamientos.`,
        },
    ]);
