...
// GestiÛn completa de rutinas: ver, editar, eliminar
// =====================================================
...
const DAY_STYLE: Record<string, { color: string, bg: string }> = {
    ...
    'MiÈrcoles': { color: '#FF9500', bg: 'rgba(255, 149, 0, 0.05)' },
                    ...
                    <div style={styles.editRow}>
                        ...
                        <div style={styles.editField}>
                            ...
                            >
                                ...
                                }}>{editedExercise.isOptional ? 'SÌ' : 'No'}</span>
                            </div>
                        </div>
                    </div>
                    <div style={styles.editRow}>
                        ...
                        const imageContent = (
                            <>
                                ...
                                {ejercicio.categoria === 'calentamiento' && (
                                    <div style={styles.calentamientoBadge}>üî•</div>
                                )}
                            </>
                        );
...
export const RoutineDetailPage: React.FC = () => {
    ...
    const handleIAOrganize = async () => {
        ...
        try {
            ...
            toast.success("°Rutina organizada con Èxito por la IA!");
        } catch (error) {
            console.error(error);
    ...
    const handleDeleteExercise = (id: string) => {
        ...
        toast((t) => (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <span style={{ fontSize: '14px', fontWeight: 600 }}>øEliminar este ejercicio?</span>
            ...
            <Card style={styles.infoCard}>
                        ...
                        <div style={styles.expirationText}>
                            {routineInfo.expirada ? (
                                <>
                                    ...
                                    <span style={styles.expirationSubtitle}>FinalizÛ el {formatDate(routineInfo.fechaFin)}</span>
                                </>
                            ) : (
                                <>
                                    <span style={{ ...styles.expirationTitle, color: routineInfo.proximaACaducar ? Colors.warning : Colors.success }}>{routineInfo.diasRestantes} dÌas restantes</span>
                ...
                {rutina.analizadaPorIA && (
                    <div style={{ ...styles.durationRow, marginTop: '8px' }}>
                        <span style={styles.aiTag}>ü§ñ IA</span>
                    </div>
                )}
            </Card>
                ...
                showDeleteModal && (
                    <div style={styles.modalOverlay}>
                        <div style={styles.modal}>
                            ...
                            <p style={styles.modalText}>Esta acciÛn eliminar· permanentemente tu rutina &quot;{rutina.nombre}&quot; y todos sus ejercicios.</p>
                    ...
                    <div style={styles.modalOverlay}>
                        <div style={styles.modal}>
                            ...
                            <div style={styles.addForm}>
                                ...
                                <div style={styles.formRow}>
                                    <div style={styles.formGroup}>
                                        <label style={styles.formLabel}>CategorÌa</label>
                                ...
                                <button style={styles.addExerciseSubmitBtn} onClick={handleAddExercise} disabled={!newExercise.nombre}><Plus size={20} /> AÒadir Ejercicio</button>
